...
/*
    Leaderboard Page for Intermedio category
*/

const LeaderboardPageIntermedio = () => {
    ...
    const fetchLeaderboards = () => {
        ...
        AxiosObj.get('/participants/')
            .then(response => {
                ...
                let intermedioParticipants = participants.filter(p => 
                    p.cup === 'intermedio' && 
                    !p.is_staff && 
                    !p.is_superuser && 
                    p.is_active
                ...
                if (genderFilter === 'male') {
                    intermedioParticipants =
                        intermedioParticipants.filter(p => p.gender === 'M');
                ...
                setLeaderboards({
                    kids: [],
                    principiante: [],
                    intermedio: intermedioParticipants,
                    avanzado: [],
                });
                setLoading(false);
            })
        ...
        >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', 
                ...
                <ButtonGroup variant="contained" sx={{ boxShadow: 2 }}>
                    <Button
                        ...
                        sx={{
                            backgroundColor: 
                            genderFilter === 'all' ? '#45B7D1' : '#e0e0e0',
                            color: genderFilter === 'all' ? '#fff' : '#666',
                            '&:hover': {
                                backgroundColor: 
                                genderFilter === 'all' ?'#3a9fc0':'#d0d0d0',
                            },
                        }}
                    >
                        Todos
                    ...
                    <Button
                        ...
                        sx={{
                            backgroundColor: 
                            genderFilter === 'male' ? '#45B7D1' : '#e0e0e0',
                            color: genderFilter === 'male' ? '#fff' :'#666',
                            '&:hover': {
                                backgroundColor: 
                                genderFilter === 'male'?'#3a9fc0':'#d0d0d0',
                            },
                        }}
                    >
                        Varonil
                    ...
                    <Button
                        ...
                        sx={{
                            backgroundColor: 
                            genderFilter === 'female' ? '#45B7D1':'#e0e0e0',
                            color: 
                            genderFilter === 'female' ? '#fff' : '#666',
                            '&:hover': {
                                backgroundColor: 
                                genderFilter==='female'?'#3a9fc0':'#d0d0d0',
                            },
                        }}
                    >
                        Femenil
            ...
            >
                <Box sx={{ mb: 3, width: '100%' }}>
                    ...
                    >
                        {leaderboards.intermedio.length === 0 ? (
                            <Box
                                sx={{
                                    textAlign: 'center',
                                    py: 4,
...
export default LeaderboardPageIntermedio;