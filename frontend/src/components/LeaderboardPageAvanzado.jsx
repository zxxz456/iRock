...
/*
    Leaderboard Page for Avanzado category
*/

const LeaderboardPageAvanzado = () => {
    ...
    const fetchLeaderboards = () => {
        ...
        AxiosObj.get('/participants/')
            .then(response => {
                ...
                let avanzadoParticipants = participants.filter(p => 
                    p.cup === 'avanzado' && 
                    !p.is_staff && 
                    !p.is_superuser && 
                    p.is_active
                ...
                if (genderFilter === 'male') {
                    avanzadoParticipants = 
                        avanzadoParticipants.filter(p => p.gender === 'M');
                } else if (genderFilter === 'female') {
                    avanzadoParticipants = 
                        avanzadoParticipants.filter(p => p.gender === 'F');
                }
                
                // Sort by points
                avanzadoParticipants.sort((a, b) => b.points - a.points);

                setLeaderboards({
                    kids: [],
                    principiante: [],
                    intermedio: [],
                    avanzado: avanzadoParticipants,
                });
                setLoading(false);
            })
            .catch(error => {
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', 
                ...
                <ButtonGroup variant="contained" sx={{ boxShadow: 2 }}>
                    <Button
                        ...
                        sx={{
                            backgroundColor: 
                            genderFilter === 'all' ? '#FFA07A' : '#e0e0e0',
                            color: 
                            genderFilter === 'all' ? '#fff' : '#666',
                            '&:hover': {
                                backgroundColor: 
                                genderFilter === 'all' ? '#ff8c60' : 
                                                 '#d0d0d0',
                            },
                        }}
                    >
                    ...
                    <Button
                        ...
                        sx={{
                            backgroundColor: 
                            genderFilter === 'male' ? '#FFA07A' : '#e0e0e0',
                            color: 
                            genderFilter === 'male' ? '#fff' : '#666',
                            '&:hover': {
                                backgroundColor: 
                                genderFilter === 'male' ? '#ff8c60' :
                                                 '#d0d0d0',
                            },
                        }}
                    >
                    ...
                    <Button
                        ...
                        sx={{
                            backgroundColor: 
                            genderFilter === 'female' ? '#FFA07A':'#e0e0e0',
                            color: 
                            genderFilter === 'female' ? '#fff' : '#666',
                            '&:hover': {
                                backgroundColor: 
                                genderFilter === 'female' ? '#ff8c60' : 
                                                 '#d0d0d0',
                            },
                        }}
                    >
                ...
                <Box sx={{ mb: 3, width: '100%' }}>
                    <Paper
                        ...
                        sx={{
                            p: 3,
                            borderRadius: 2,
                            borderTop: '4px solid #FFA07A',
                            minHeight: 400,
                        }}
                    >
                        {leaderboards.avanzado.length === 0 ? (
                            <Box
                                sx={{
                                    textAlign: 'center',
                                    py: 4,
...
export default LeaderboardPageAvanzado;